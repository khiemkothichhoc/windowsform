...
namespace baitap1
{
    public partial class frmCauHinh : Form
    {
        ...
        public void GhiDuLieu()
        {
            try
            {
                string filePath = Path.Combine(@"C:\Users\Thuan\source\repos\Winform\10123308_NguyenDuyThuan_TH03\BT1\bin\Debug", "Save.txt");

                string quyenTruyCap = wd.Checked ? "Windows Authentication" : "SQL Authentication";
                string serverName = tenmay.Text;
                string database = data.Text;
                string account = uname.Text;
